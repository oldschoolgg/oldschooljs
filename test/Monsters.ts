...
test('Corporeal Beast', async (test): Promise<void> => {
	const expectedRates = {
		...
		'Mystic water staff': 30.11,
		'Mystic earth staff': 30.11,
		'Mystic fire staff': 30.11,
		'Mystic robe top': 30.11,
		'Mystic robe bottom': 30.11,
		'Onyx bolts (e)': 25.6 / 175,
		Cannonball: 30.11 / 2000,
		'Adamant arrow': 30.11 / 750,
		'Runite bolts': 30.11 / 250,
		'Law rune': 30.11 / 250,
		'Cosmic rune': 30.11 / 500,
		'Death rune': 30.11 / 300,
		'Soul rune': 30.11 / 250,
		'Adamantite ore': 30.11 / 125,
		'Runite ore': 30.11 / 20,
		'Adamantite bar': 30.11 / 35,
		'Teak plank': 30.11 / 100,
		'Mahogany logs': 30.11 / 150,
		'Magic logs': 30.11 / 75,
		'Green dragonhide': 30.11 / 100,
		'Raw shark': 30.11 / 70,
		'Pure essence': 30.11 / 2500,
		'Watermelon seed': 34.13 / 24,
		'White berries': 34.13 / 120,
		'Desert goat horn': 34.13 / 120,
		'Tuna potato': 34.13 / 30,
		'Antidote++(4)': 34.14 / 40,
		'Ranarr seed': 170.67 / 10,
		'Clue scroll (elite)': 200,
		'Pet dark core': 5000
	};

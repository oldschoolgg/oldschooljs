...
test('General Graardor', async (test): Promise<void> => {
	...
	test.equals(GeneralGraardor.table.totalWeight, 508, 'General Graardor table weight should be 508');
...
test('Commander Zilyana', async (test): Promise<void> => {
	...
	test.equals(CommanderZilyana.table.totalWeight, 508, 'Commander Zilyana table weight should be 508');
...
test("Kree'arra", async (test): Promise<void> => {
	...
	test.equals(Kreearra.table.totalWeight, 508, "Kree'arra table weight should be 508");
...
test("K'ril Tsutsaroth", async (test): Promise<void> => {
	...
	test.equals(KrilTsutsaroth.table.totalWeight, 508, "K'ril Tsutsaroth table weight should be 508");

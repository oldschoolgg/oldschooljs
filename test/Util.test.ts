...
describe('Utils', () => {
	test('toKMB checks', async () => {
		...
		expect(Util.toKMB(1000000)).toEqual('1m');
		expect(Util.toKMB(1500000)).toEqual('1.5m');
		expect(Util.toKMB(15000000)).toEqual('15m');
		expect(Util.toKMB(150000000)).toEqual('150m');

		expect(Util.toKMB(1000000000)).toEqual('1b');
		expect(Util.toKMB(1200000000)).toEqual('1.2b');
		expect(Util.toKMB(50000000000)).toEqual('50b');
	});
	...
	test('KMB checks', async () => {
		...
		expect(Util.fromKMB('1m')).toEqual(1000000);
		expect(Util.fromKMB('1.5m')).toEqual(1500000);
		expect(Util.fromKMB('15m')).toEqual(15000000);
		expect(Util.fromKMB('150m')).toEqual(150000000);

		expect(Util.fromKMB('1b')).toEqual(1000000000);
		expect(Util.fromKMB('1.2b')).toEqual(1200000000);
		expect(Util.fromKMB('50b')).toEqual(50000000000);
	});

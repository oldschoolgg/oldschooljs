...
describe('Clues', () => {
	...
	test.concurrent('Hard Clues', (done) => {
		const expectedRates = {
			...
			'Super energy(4)': 16_250 / 5 / 15,
			'Super restore(4)': 16_250 / 5 / 15,
			'Super attack(4)': 16_250 / 5 / 5,
			'Super defence(4)': 16_250 / 5 / 5,
			'Super strength(4)': 16_250 / 5 / 5,
			'Gilded full helm': 35_750 / 5,
			'Gilded chainbody': 35_750 / 5,
			'3rd age platelegs': 211_250 / 5,
			'3rd age range coif': 211_250 / 5,
			'3rd age robe': 211_250 / 5
		};
	...
	test.concurrent('Elite Clues', (done) => {
		const expectedRates = {
			...
			'Ring of nature': 28_750 / 5,
			'Crystal key': 28_750 / 5,
			'Gilded scimitar': 28_750 / 5,
			'Gilded sq shield': 63_250 / 5,
			'3rd age full helmet': 488_750 / 5,
			'3rd age vambraces': 488_750 / 5,
			'3rd age wand': 488_750 / 5,
			'Ranging potion(4)': 28_750 / 5 / 30,
	...
	test.concurrent('Master Clues', (done) => {
		const expectedRates = {
			...
			'Dragon platebody ornament kit': 12_765 / 6,
			'Ankou socks': 12_765 / 6,
			"Mummy's hands": 12_765 / 6,
			'Dragon kiteshield ornament kit': 25_530 / 6,
			'Bucket helm (g)': 13_616 / 6,
			'Ring of coins': 13_616 / 6,
			Cabbage: 13_616 / 6 / 3,
			'Anti-venom+(4)': 13_616 / 6 / 15,
			Torstol: 13_616 / 6 / 50,
			"Gilded d'hide vambraces": 13_616 / 6,
			'Gilded spade': 13_616 / 6,
			'Gilded full helm': 149_776 / 6,
			'Gilded 2h sword': 149_776 / 6,
			'3rd age full helmet': 313_168 / 6,
			'3rd age druidic robe top': 313_168 / 6,
			'3rd age axe': 313_168 / 6,

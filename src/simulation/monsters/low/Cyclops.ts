...
import UncommonSeedDropTable from '../../subtables/CommonSeedDropTable';
...
export const CyclopsTable = new LootTable()
	...
	/* Catacombs tertiary (Average) */
	.tertiary(275, 'Ancient shard')
	.tertiary(412, 'Dark totem base')
	.tertiary(412, 'Dark totem middle')
	.tertiary(412, 'Dark totem top');

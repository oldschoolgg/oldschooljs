...
const WildySlayerCaveTable = new LootTable()
	...
	.add("Blighted vengeance sack", [1, 10], 179)
	.add("Blighted super restore(4)", 1, 358)
	.add("Revenant cave teleport", 1, 358)
	.add("Dareeyak teleport", 1, 1790)
	.add("Wilderness crabs teleport", 1, 1790)
	.add("Carrallanger teleport", 1, 1790)
	.add("Paddewwa teleport", 1, 1790)
	.add("Annakarl teleport", 1, 1790)
	.add("Lassar teleport", 1, 1790)
	.add("Kharyrll teleport", 1, 1790)
	.add("Senntisten teleport", 1, 1790)
	.add("Ghorrock teleport", 1, 1790)

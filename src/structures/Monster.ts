import { MonsterOptions, MonsterKillOptions, NumberKeyedBank } from '../meta/types';
...
export default abstract class Monster {
	...
	public abstract kill(quantity: number, options: MonsterKillOptions): NumberKeyedBank;

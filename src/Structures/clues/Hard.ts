...
import {PrayerPageTable, FirelighterTable, TeleportScrollTable, BlessingTable, GildedTable} from './General'
...
export const HardRareTable = new LootTable()
	...
	.addItem("Zamorak platebody")	//ZAMORAK
	...
	.addItem("Saradomin platebody")	//SARADOMIN
	...
	.addItem("Guthix platebody")	//GUTHIX
	...
	.addItem("Bandos platebody")	//BANDOS
	...
	.addItem("Armadyl platebody")	//ARMADYL
	...
	.addItem("Ancient platebody")	//ANCIENT
	...
	.addItem("Blue d'hide body (t)")	//D'HIDE

...
export const CaveHorrorTable = new LootTable()
	...
	/* Herbs */
	.add(HerbDropTable, undefined, 13)

	/* Seeds */
	.add(RareSeedTable, undefined, 18)
	.add(VariableAllotmentSeedTable, undefined, 15)
...
export default new SimpleMonster({ id: 3209, name: 'Cave Horror', table: CaveHorrorTable });

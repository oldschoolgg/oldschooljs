...
const CalvarionUniqueTable = new LootTable_1.default()
...
const CalvarionSecondarySupplyTable = new LootTable_1.default({ limit: 18 })
...
const CalvarionTable = new LootTable_1.default()
    .every("Big bones")
...
const CalvarionTotalTable = new LootTable_1.default().every(CalvarionSecondarySupplyTable).every(CalvarionTable);

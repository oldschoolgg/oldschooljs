...
const ArtioUniqueTable = new LootTable_1.default()
...
const ArtioSecondarySupplyTable = new LootTable_1.default({ limit: 18 })
...
const ArtioTable = new LootTable_1.default()
    .every("Big bones")
...
const ArtioTotalTable = new LootTable_1.default().every(ArtioSecondarySupplyTable).every(ArtioTable);

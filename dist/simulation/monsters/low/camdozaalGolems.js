...
exports.CamdozaalGolems = void 0;
const LootTable_1 = __importDefault(require("../../../structures/LootTable"));
const SimpleMonster_1 = __importDefault(require("../../../structures/SimpleMonster"));
const FlawedGolem = new SimpleMonster_1.default({
    id: 10_695,
    name: "Flawed Golem",
...
const MindGolem = new SimpleMonster_1.default({
    id: 10_693,
    name: "Mind Golem",
    table: new LootTable_1.default()
...
const BodyGolem = new SimpleMonster_1.default({
    id: 10_691,
    name: "Body Golem",
    table: new LootTable_1.default()
...
const ChaosGolem = new SimpleMonster_1.default({
    id: 10_689,
    name: "Chaos Golem",
    table: new LootTable_1.default()
...
exports.CamdozaalGolems = { FlawedGolem, MindGolem, BodyGolem, ChaosGolem };

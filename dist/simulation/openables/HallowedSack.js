...
const LowTierLootTable = new LootTable_1.default()
    ...
    .add("White lily")
    .add("Coins", [1500, 3000]);
const MidTierLootTable = new LootTable_1.default()
...
const HighTierLootTable = new LootTable_1.default()
    .add("Rune 2h sword")
    .add("Rune platebody")
...
exports.HallowedSackTable = new LootTable_1.default()
...
exports.default = new SimpleOpenable_1.default({
    ...
    table: exports.HallowedSackTable,
});

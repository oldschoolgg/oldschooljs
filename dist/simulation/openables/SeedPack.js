...
exports.SeedPackOpenable = void 0;
const e_1 = require("e");
...
const LowSeedPackTable = new LootTable_1.default()
...
const MediumSeedPackTable = new LootTable_1.default()
    .add("Irit seed", [2, 6], 3)
    ...
    .add("Teak seed", [1, 3], 1);
const HighSeedPackTable = new LootTable_1.default()
...
const SeedPackTable = new LootTable_1.default().add(LowSeedPackTable).add(MediumSeedPackTable).add(HighSeedPackTable);
class SeedPackOpenable extends SimpleOpenable_1.default {
    open(quantity = 1, options = { seedTier: "5" }) {
        const tempTable = new LootTable_1.default();
        ...
        switch (tier) {
            ...
            case "2": {
                ...
                medium = (0, e_1.randInt)(2, 3);
                low = 7 - medium - high;
                break;
            }
            case "3": {
                high = (0, e_1.randInt)(0, 1);
                medium = (0, e_1.randInt)(2, 4);
                low = 8 - medium - high;
                break;
            }
            case "4": {
                high = (0, e_1.randInt)(1, 2);
                medium = (0, e_1.randInt)(3, 5);
                low = 9 - medium - high;
                break;
            }
            default: {
                high = (0, e_1.randInt)(1, 3);
                medium = (0, e_1.randInt)(4, 6);
                low = 10 - medium - high;
                break;
            }
        }
...
exports.SeedPackOpenable = SeedPackOpenable;
exports.default = new SeedPackOpenable({
    id: 22_993,
    name: "Seed pack",
    aliases: ["seed pack"],
    table: SeedPackTable,

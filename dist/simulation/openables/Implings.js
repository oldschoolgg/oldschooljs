...
exports.Implings = exports.LuckyImpling = exports.DragonImpling = exports.CrystalImpling = exports.NinjaImpling = exports.MagpieImpling = exports.NatureImpling = exports.EclecticImpling = exports.EssenceImpling = exports.EarthImpling = exports.GourmetImpling = exports.YoungImpling = exports.BabyImpling = void 0;
const LootTable_1 = __importDefault(require("../../structures/LootTable"));
const SimpleOpenable_1 = __importDefault(require("../../structures/SimpleOpenable"));
const Easy_1 = require("../clues/Easy");
const Elite_1 = require("../clues/Elite");
const Hard_1 = require("../clues/Hard");
const Master_1 = require("../clues/Master");
const Medium_1 = require("../clues/Medium");
exports.BabyImpling = new SimpleOpenable_1.default({
    id: 11_238,
    name: "Baby impling",
    ...
    table: new LootTable_1.default()
        ...
        .add("Anchovies", 1, 10)
        .add(new LootTable_1.default(), 1, 10)
        .add("Spice")
        .add("Flax")
        .add("Mud pie")
        .add("Seaweed")
...
exports.YoungImpling = new SimpleOpenable_1.default({
    id: 11_240,
    name: "Young impling",
...
exports.GourmetImpling = new SimpleOpenable_1.default({
    id: 11_242,
...
exports.EarthImpling = new SimpleOpenable_1.default({
    id: 11_244,
    name: "Earth impling",
...
exports.EssenceImpling = new SimpleOpenable_1.default({
    id: 11_246,
...
exports.EclecticImpling = new SimpleOpenable_1.default({
    id: 11_248,
...
exports.NatureImpling = new SimpleOpenable_1.default({
    id: 11_250,
    name: "Nature impling",
...
exports.MagpieImpling = new SimpleOpenable_1.default({
    id: 11_252,
    name: "Magpie impling",
...
exports.NinjaImpling = new SimpleOpenable_1.default({
    id: 11_254,
    name: "Ninja impling",
...
exports.CrystalImpling = new SimpleOpenable_1.default({
    id: 23_768,
...
exports.DragonImpling = new SimpleOpenable_1.default({
    id: 11_256,
    name: "Dragon impling",
...
exports.LuckyImpling = new SimpleOpenable_1.default({
    id: 19_732,
    name: "Lucky impling",
    aliases: ["lucky impling", "lucky imp", "lucky", "luckys"],
    table: new LootTable_1.default()
        .add(Easy_1.EasyClueTable)
        .add(Medium_1.MediumClueTable)
        .add(Hard_1.HardClueTable)
        .add(Elite_1.EliteClueTable)
        .add(Master_1.MasterClueTable),
});
exports.Implings = [
    exports.BabyImpling,
    exports.YoungImpling,
    exports.GourmetImpling,
    exports.EarthImpling,
    exports.EssenceImpling,
    exports.EclecticImpling,
    exports.NatureImpling,
    exports.MagpieImpling,
    exports.NinjaImpling,
    exports.CrystalImpling,
    exports.DragonImpling,
    exports.LuckyImpling,
];

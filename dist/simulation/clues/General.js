...
exports.BlessingTable = exports.GiveHalfKeyTable = exports.TeleportScrollTable = exports.SubTeleportScrollTable = exports.FirelighterTable = exports.GildedTable = exports.PrayerPageTable = void 0;
const LootTable_1 = __importDefault(require("../../structures/LootTable"));
exports.PrayerPageTable = new LootTable_1.default()
    ...
    .add("Ancient page 3")
    .add("Ancient page 4");
exports.GildedTable = new LootTable_1.default()
    ...
    .add("Gilded spear")
    .add("Gilded hasta");
exports.FirelighterTable = new LootTable_1.default()
...
exports.SubTeleportScrollTable = new LootTable_1.default()
...
exports.TeleportScrollTable = new LootTable_1.default().add("Master scroll book (empty)").add(exports.SubTeleportScrollTable, 1, 21);
exports.GiveHalfKeyTable = new LootTable_1.default().add("Loop half of key").add("Tooth half of key");
exports.BlessingTable = new LootTable_1.default()
    .add("Holy blessing")
    .add("Unholy blessing")

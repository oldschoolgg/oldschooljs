...
const PoolCasketTable = new LootTable_1.default()
...
function Tempoross({ quantity, fishingLevel, userBank, }) {
    const loot = new Bank_1.default();
    const lootTable = new LootTable_1.default()
